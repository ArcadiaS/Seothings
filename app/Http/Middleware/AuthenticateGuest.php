...
class AuthenticateGuest
{
    ...
    {
        // todo: bu kontrol işe yarıyor mu bakılacak. Check ile kontrol +  sistemdeki domainlerden istek gelmesi gerekiyor.
        if (!\Auth::check()) {
    ...
    private function ua_is_bot($user_agent) {
        ...
        return preg_match($botPattern, $user_agent);
    }
}
